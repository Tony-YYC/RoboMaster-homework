...
public:
    ...
    void relocate(Eigen::Vector3d newcamLoca,Eigen::Quaterniond newimuSense);
    void showObjsLoca(cv::Mat & picture,std::vector<Eigen::Vector3d> objWldLocas,std::vector<int> radius);
    Camera();
};